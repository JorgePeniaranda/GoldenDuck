...
export default function BaseButton({children, className, type = 'button', yPadding = "0.5rem", xPadding = "1rem", backgroundColor = "var(--primary)", fontWeight, fontSize, fontColor, href}: Props) {
  const props = {
